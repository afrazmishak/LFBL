...
$existing_details_query = "SELECT * FROM `volunteer_users` WHERE `id`='$id'";
...
if ($existing_details_result && mysqli_num_rows($existing_details_result) > 0) {
    ...
    if (isset($_POST['submitDetails'])) {
        ...
        // Perform the update
        $update_query = "UPDATE `volunteer_users` SET `email`='$email', `userpassword`='$hashed_password'";
...
<body>
    <div class="wrapper">
        ...
        <div class="form-box">
            <form class="login-container" id="login" action="organization_editVolusers.php?id=<?php echo $id; ?>"
                method="POST" enctype="multipart/form-data">
                <p class="header">Volunteer Users</p>
