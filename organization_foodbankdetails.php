...
$existing_details_query = "SELECT * FROM `foodbankdetails` WHERE `id`='$id'";
...
if ($existing_details_result && mysqli_num_rows($existing_details_result) > 0) {
    ...
    if (isset($_POST['submitDetails'])) {
        ...
        // Perform the update
        $update_query = "UPDATE `foodbankdetails` SET `bankname`='$bankname', `incharger`='$incharger', `contactnumber`='$contactnumber', `location_address`='$location_address', `city`='$city', `postalcode`='$postalcode'";
        
        // Update image location if it's uploaded
        if (!empty($imagelocation)) {
            $update_query .= ", `imagelocation`='$imagelocation'";
        }
        ...
        if ($update_result) {
            ...
            echo "<script>
                ...
                function closePopup() {
                    window.location.href = 'organization_foodbanks.php?success!'; // Redirect to home.php
                }
              </script>";
        } else {
...
<body>
    <div class="wrapper">
        ...
        <div class="form-box">
            <form class="login-container" id="login" action="organization_foodbankdetails.php?id=<?php echo $id; ?>"
            ...
            <div class="notification-popup" id="notificationPopup">
                <div class="notification-content">
                    ...
                    <div class="notification-buttons">
                        <button onclick="confirmDelete(<?php echo $id; ?>)">Yes</button>
...
<script>
    ...
    function confirmDelete(id) {
        ...
        window.location.href = 'delete_organization_foodbankdetails.php?id=' + id;
    }
