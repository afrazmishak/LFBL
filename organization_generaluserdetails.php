...
$existing_details_query = "SELECT * FROM `general_userdetails` WHERE `id`='$id'";
...
if ($existing_details_result && mysqli_num_rows($existing_details_result) > 0) {
    ...
    if (isset($_POST['submitDetails'])) {
        ...
        // Perform the update
        $update_query = "UPDATE `general_userdetails` SET `firstname`='$firstname', `lastname`='$lastname', `dateofbirth`='$dateofbirth', `address`='$address', `city`='$city', 
        ...
        if ($update_result) {
            ...
            echo "<script>
                ...
                function closePopup() {
                    window.location.href = 'organization_generalusers.php?success!'; // Redirect to home.php
                }
              </script>";
        } else {
...
<body>
    <div class="wrapper">
        ...
        <div class="form-box">
            <form class="login-container" id="login" action="organization_generaluserdetails.php?id=<?php echo $id; ?>"
