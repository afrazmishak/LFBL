...
<body>
    <div class="wrapper">
        ...
        <div class="form-box">
            <form class="login-container" id="login" action="login_users.php" method="POST">
                <div class="top">
            ...
            <form class="register-container" id="register" action="register_users.php" method="POST">
                <div class="top">
                ...
                <div class="input-box">
                    <input type="password" class="input-field" name="reuserpassword" placeholder="Re-enter Password">
                    <i class="bx bx-lock-alt"></i>
                </div>
