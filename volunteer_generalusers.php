...
$query = "SELECT volunteer_users.id, foodbankdetails.imagelocation, foodbankdetails.bankname
FROM volunteer_users 
JOIN foodbankdetails ON volunteer_users.id = foodbankdetails.volunteer_user_id 
WHERE volunteer_users.email='$email'";
...
$sqltwo = "SELECT general_userdetails.*, general_users.last_login_time 
           FROM general_userdetails 
           LEFT JOIN general_users ON general_userdetails.general_user_id = general_users.id";
    ...
    <section id="interface">
        ...
        <div class="modal" id="profile_modal">
            <div class="modal-content">
                ...
                <?php if (isset($bankname) && !empty($bankname)): ?>
                    <p><?php echo $bankname; ?></p>
                <?php endif; ?>
                <a href="./volunteerdetails.php" id="edit_profile">Edit Profile</a>
                <a href="#" id="change_password">Change Password</a>
                <a href="./logout_volunteers.php" id="logout">Logout</a>
            </div>
        </div>
                            ...
                            <tr>
                                ...
                                <td class="edit">
                                    ...
                                    <div class="details-box">
                                        ...
                                        <p>Primary Phone Number: <?php echo $row['primaryphone']; ?></p>
                                        <p>Secondary Phone Number: <?php echo $row['secondaryphone']; ?></p>
...
<script>
    ...
    function editUserDetails(id) {
        window.location.href = 'organization_generaluserdetails.php?id=' + id;
    }
</script>
